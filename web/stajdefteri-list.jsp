...
<body>
	...
	<div class="row">
		<div class="container">
			<h3 class="text-center" style="font-style: italic; color: white;">Staj Defteri Listesi</h3>
			<hr style="background-color: white;">
                        <c:if test="${loggedOgrenci != null }">
			<div class="container text-left">
				 <a href="<%=request.getContextPath()%>/yeniStajdefteri" class="btn btn-success" style="background-color: gray;">Yeni Staj Defteri Ekle</a>
			</div>
                        </c:if>
			<br>
				...
				<tbody>
					<c:forEach var="stajDefteri" items="${listStajdefteri}">
						<tr>
							...
							<td><c:out value="${stajDefteri.stajBasvuru.sirket.ad}" /></td>
							...
							<td><a href="stajdefteriDuzenle?id=<c:out value='${stajDefteri.id}' />">Düzenle</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
