...
<body>
    ...
    <header>    
        ...
        <div><img src="C:\Users\tuğçe\Desktop\İnternet Mühendisliği\Proje Ödevi\logo.png"/></div> 
	...
	<div class="row">
		<div class="container">
                    <h3 class="text-center" style="font-style: italic; color: white">Danışman Bilgileri</h3>
				...
				<tbody>
					<c:forEach var="user" items="${listDanisman}">
						<tr>
							...
							<td><a href="danismanDuzenle?id=<c:out value='${user.id}' />">Düzenle</a>
								&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
					</c:forEach>
